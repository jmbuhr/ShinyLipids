...
It serves as the primary visualization dashboard for lipidomics mass spectrometry in the
...
as a car with a nice dashboard around the engine to help you control all that raw power.
Don't worry, there won't be any coding necessary to get started with your data in ShinyLipids.
