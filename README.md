...
dashboard for lipidomics mass spectrometry in the [Brügger Lipidomics
Group](https://bzh.db-engine.de/default.asp?lfn=2241&fg=4289) at the
Heidelberg Biochemistry Center (BZH).
...
for the implementation of new features within the R code. You can find
...
engine to help you control all that raw power. Don’t worry, there won’t
be any coding necessary to get started with your data in ShinyLipids.
